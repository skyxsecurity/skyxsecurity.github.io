...
1. `CCS'25` **BACScan: Automatic Black-Box Detection of Broken-Access-Control Vulnerabilities in Web Applications**   
  ...
  In *Proceedings of the 32nd ACM Conference on Computer and Communications Security*, October 2025.  
  [to appear]
...
1. `WWW'24` **RecurScan: Detecting Recurring Vulnerabilities in PHP Web Applications**  
  ...
  In *Proceedings of the 33rd ACM Web Conference*, May, 2024.      
...
1. `ASE'22` **Precise (Un)Affected Version Analysis for Web Vulnerabilities**  
  ...
  In *Proceedings of the 37th IEEE/ACM International Conference on Automated Software Engineering*, October, 2022.  
